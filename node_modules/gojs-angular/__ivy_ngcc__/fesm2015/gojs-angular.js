import { EventEmitter, Component, IterableDiffers, KeyValueDiffers, NgZone, Input, Output, ViewChild, NgModule, Injectable, ɵɵdefineInjectable } from '@angular/core';
...
DiagramComponent.ɵfac = function DiagramComponent_Factory(t) { return new (t || DiagramComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.KeyValueDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
DiagramComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DiagramComponent, selectors: [["gojs-diagram"]], viewQuery: function DiagramComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c0, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.diagramDiv = _t.first);
    } }, inputs: { linkDataArray: "linkDataArray", modelData: "modelData", modelChangedListener: "modelChangedListener", skipsDiagramUpdate: "skipsDiagramUpdate", initDiagram: "initDiagram", nodeDataArray: "nodeDataArray", divClassName: "divClassName" }, outputs: { modelChange: "modelChange" }, decls: 2, vars: 1, consts: [[3, "className"], ["ngDiagram", ""]], template: function DiagramComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DiagramComponent, [{
    ...
    }], function () { return [{ type: ɵngcc0.IterableDiffers }, { type: ɵngcc0.KeyValueDiffers }, { type: ɵngcc0.NgZone }]; }, { linkDataArray: [{
            type: Input
        }], modelData: [{
            type: Input
...
class PaletteComponent {
    ...
    updateFromAppData() {
        ...
        if (this.linkDataArray && model instanceof GraphLinksModel) {
...
PaletteComponent.ɵfac = function PaletteComponent_Factory(t) { return new (t || PaletteComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.KeyValueDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone)); };
PaletteComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PaletteComponent, selectors: [["gojs-palette"]], viewQuery: function PaletteComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵstaticViewQuery(_c1, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.paletteDiv = _t.first);
    } }, inputs: { linkDataArray: "linkDataArray", modelData: "modelData", modelChangedListener: "modelChangedListener", initPalette: "initPalette", nodeDataArray: "nodeDataArray", divClassName: "divClassName" }, outputs: { modelChange: "modelChange" }, decls: 2, vars: 1, consts: [[3, "className"], ["ngPalette", ""]], template: function PaletteComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", 0, 1);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("className", ctx.divClassName);
    } }, encapsulation: 2 });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(PaletteComponent, [{
        type: Component,
        args: [{
...
OverviewComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: OverviewComponent, selectors: [["gojs-overview"]], viewQuery: function OverviewComponent_Query(rf, ctx) { if (rf & 1) {
...
GojsAngularModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: GojsAngularModule });
GojsAngularModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function GojsAngularModule_Factory(t) { return new (t || GojsAngularModule)(); }, imports: [[]] });
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(GojsAngularModule, [{
        type: NgModule,
        args: [{
                declarations: [
                    DiagramComponent,
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(DataSyncService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
