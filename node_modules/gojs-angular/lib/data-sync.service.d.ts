...
export declare class DataSyncService {
     ...
     */
    static syncNodeData(changes: go.IncrementalData, nodeData: Array<go.ObjectData>): go.ObjectData[];
    /**
     ...
     */
    static syncLinkData(changes: go.IncrementalData, linkData: Array<go.ObjectData>): go.ObjectData[];
    /**
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<DataSyncService, never>;
}
